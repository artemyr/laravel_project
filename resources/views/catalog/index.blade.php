                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-2">
                            <a href="{{ filter_url($category, ['view' => 'grid']) }}"
                               class="@if(is_catalog_view('grid')) text-pink pointer-events-none @else text-white @endif inline-flex items-center justify-center w-10 h-10 rounded-md bg-card">
