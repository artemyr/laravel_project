                ...
                <div class="products grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-x-8 gap-y-8 lg:gap-y-10 2xl:gap-y-12">
                    ...
                    @foreach($viewedProducts as $vProduct)
                        ...
                        <div class="product-card flex flex-col rounded-3xl bg-card">
                            <a href="{{ route('product', $vProduct->slug) }}" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
                                <img src="{{ $vProduct->makeThumbnail('345x320') }}" class="object-cover w-full h-full" alt="{{ $vProduct->title }}">
                            </a>
                            <div class="grow flex flex-col py-8 px-6">
                                <h3 class="text-sm lg:text-md font-black">
                                    <a href="{{ route('product', $vProduct->slug) }}" class="inline-block text-white hover:text-pink">{{ $vProduct->title }}</a>
                                </h3>
                                <div class="mt-auto pt-6">
                                    <div class="mb-3 text-sm font-semibold">{{ $vProduct->price }}</div>
